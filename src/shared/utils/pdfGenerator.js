...
export const generatePDF = () => {
  ...
  doc.setFontSize(20)
  doc.setFont(undefined, 'bold')
  doc.text(cvData.personalInfo.name, pageWidth / 2 + margin, currentY, {
    align: 'center',
  })
  currentY += 8
  ...
  doc.setFontSize(12)
  doc.setFont(undefined, 'normal')
  doc.text(cvData.personalInfo.title, pageWidth / 2 + margin, currentY, {
    align: 'center',
  })
  currentY += 10
  ...
  cvData.education.forEach((edu) => {
    ...
    doc.text(`GPA: ${edu.gpa}`, pageWidth + margin - 10, currentY, {
      align: 'right',
    })
    currentY += 5
  ...
  if (
    cvData.organizationalExperience &&
    cvData.organizationalExperience.length > 0
  ) {
    addSectionHeader('Organizational Experience')
    cvData.organizationalExperience.forEach((orgExp) => {
      checkNewPage(25)
      ...
      doc.text(orgExp.period, pageWidth + margin - 10, currentY, {
        align: 'right',
      })
      currentY += 5
